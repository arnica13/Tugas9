...
// Mengeksekusi query untuk mengambil data dari empat tabel
$query = "SELECT tglmsksklh AS tglisi, registrasi.nopendaftaran AS nopendaftaran,
...
FROM registrasi 
JOIN datadiri ON registrasi.nopendaftaran = datadiri.id
JOIN dataayah ON registrasi.nopendaftaran = dataayah.id
JOIN dataibu ON registrasi.nopendaftaran = dataibu.id";
